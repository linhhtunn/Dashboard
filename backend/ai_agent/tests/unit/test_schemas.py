...
@pytest.mark.parametrize(
    "field",
    ["response_type", "source_id", "narrative_summary", "visualizations", "comparisons"],
)
...
def test_contract_response_allows_null_patient_id_and_actions() -> None:
    payload = valid_payload()
    ...
    assert response.actions[0].patient_id == "P001"
