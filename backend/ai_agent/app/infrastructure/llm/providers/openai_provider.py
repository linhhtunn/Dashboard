...
from app.infrastructure.llm.ports import LLMConfigurationError, LLMResponse, LLMStreamChunk
    ...
    async def generate_text_stream(
        ...
        *,
        ...
        async for chunk in response_stream:
            ...
            if content:
                yield LLMStreamChunk(content=content, model=self.settings.openai_model)
