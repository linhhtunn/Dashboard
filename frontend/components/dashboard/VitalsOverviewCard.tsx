  ...
  return [
    {
      ...
      changeLabel: `${Math.abs(heartRate?.changePct ?? 0)}% so với 15 phút trước`,
    ...
    },
    {
      ...
      value:
        systolic && diastolic
          ...
          : "--/--",
      unit: "mmHg",
      changeLabel: `${Math.abs(systolic?.changePct ?? 0)}% so với 15 phút trước`,
      trendColor: "text-[color:var(--cs-teal)]",
      sparkStroke: "#F5B300",
    },
  ];
      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-[color:var(--cs-text-soft)]">
            Ảnh chụp nhanh của cửa sổ theo dõi 15 phút gần nhất.
          </p>
        </div>
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-[color:rgba(0,150,136,0.18)] bg-[color:rgba(0,150,136,0.08)] px-3 py-1 text-sm text-[color:var(--cs-teal)]">
          ...
          <span className="font-medium">Ổn định trong 15 phút qua</span>
        </div>
      </div>
