...
The code implementation lives on `codex/production-hardening`, based on synchronized
`main` commit `0e2c371`. It is production-shaped but **not approved for go-live**: legal,
